    ...
    return (
        isOpen && (
            <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
                {/* 첫 번째 모달 */}
                {isFirstModalOpen && (
                    <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-auto transition-transform transform-gpu border-2 border-[#F9BB00]">
                        ...
                        <div className="flex justify-center space-x-4 mt-6">
                            ...
                            <button
                                className="px-6 py-2 bg-[#F9BB00] text-white rounded-lg hover:bg-[#F3A700] transition duration-200 focus:outline-none focus:ring focus:ring-[#F9BB00]"
                ...
                {isSecondModalOpen && (
                    <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-auto transition-transform transform-gpu border-2 border-[#F9BB00]">
                        <p className="text-center text-black text-lg font-semibold mb-4">
                            {msg}되었습니다!
                        </p>
